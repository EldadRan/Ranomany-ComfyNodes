"""
Server route for "Load Image (Edit Mode)" auto-refresh.
...
The JS extension calls this after a run (and on the refresh button) to snap the
image picker to the newest output file — the browser cannot read file mtimes.
